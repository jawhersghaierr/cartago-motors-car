...
// Returns 'better' | 'worse' | 'equal' for a numeric field where lower = better (price, mileage)
...
// Returns result for a numeric field where higher = better (horsepower)
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-carbon-950 text-carbon-950 dark:text-white">
        ...
        <div className="pt-32 pb-20 flex flex-col items-center gap-6 px-4">
          <p className="text-carbon-500 dark:text-carbon-400 text-lg">
            Sélectionnez 2 véhicules depuis le catalogue pour les comparer.
          </p>
          <Link
            href="/catalogue"
  ...
  if (!carA || !carB) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-carbon-950 text-carbon-950 dark:text-white">
        ...
        <div className="pt-32 pb-20 flex flex-col items-center gap-6 px-4">
          <p className="text-carbon-500 dark:text-carbon-400 text-lg">
            Un ou plusieurs véhicules introuvables.
          </p>
          <Link href="/catalogue" className="btn-gold flex items-center gap-2">
            <ChevronLeft size={16} />
            Retour au catalogue
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-carbon-950 text-carbon-950 dark:text-white">
      ...
      <div className="pt-24 pb-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-carbon-950 dark:text-white mb-8">
              ...
              <div key={car.id} className="bg-white dark:bg-carbon-900 rounded-2xl border border-carbon-200 dark:border-white/5 overflow-hidden">
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-2 flex-wrap">
                    <div>
                      <h2 className="text-carbon-950 dark:text-white font-bold text-lg leading-tight">
                        {car.brand} {car.model}
                      </h2>
          ...
          <div className="bg-white dark:bg-carbon-900 rounded-2xl border border-carbon-200 dark:border-white/5 overflow-hidden divide-y divide-carbon-100 dark:divide-white/5">
            ...
            <div className="px-4 py-2 bg-carbon-50 dark:bg-carbon-800/50">
              <p className="text-xs font-semibold uppercase tracking-widest text-carbon-400 dark:text-carbon-500">Prix</p>
            </div>
            ...
            {(carA.price_ht || carB.price_ht) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5">Prix HT</p>
            ...
            {(carA.price_ttc || carB.price_ttc) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5">Prix TTC</p>
            ...
            {!carA.price_ht && !carA.price_ttc && !carB.price_ht && !carB.price_ttc && (carA.price || carB.price) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5">Prix</p>
                  <p className={`text-base ${carA.price ? highlightClass(pA) : 'text-carbon-400'}`}>
                    {carA.price ? formatPrice(carA.price) : 'Sur demande'}
                  </p>
                </div>
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5">Prix</p>
                  <p className={`text-base ${carB.price ? highlightClass(pB) : 'text-carbon-400'}`}>
                    {carB.price ? formatPrice(carB.price) : 'Sur demande'}
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="px-4 py-2 bg-carbon-50 dark:bg-carbon-800/50">
              <p className="text-xs font-semibold uppercase tracking-widest text-carbon-400 dark:text-carbon-500">Motorisation</p>
            </div>

            {/* Fuel */}
            <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
              <div className="px-5 py-3.5">
                <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5 flex items-center gap-1"><Fuel size={11} />Carburant</p>
            ...
            {(carA.engine || carB.engine) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5">Moteur</p>
            ...
            <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
              <div className="px-5 py-3.5">
                <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5 flex items-center gap-1"><Settings size={11} />Transmission</p>
            ...
            {(carA.horsepower || carB.horsepower) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5 flex items-center gap-1"><Zap size={11} />Puissance</p>
            ...
            {/* Section: Kilométrage & Finition */}
            <div className="px-4 py-2 bg-carbon-50 dark:bg-carbon-800/50">
              <p className="text-xs font-semibold uppercase tracking-widest text-carbon-400 dark:text-carbon-500">Détails</p>
            </div>
            ...
            {(carA.mileage || carB.mileage) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5 flex items-center gap-1"><Gauge size={11} />Kilométrage</p>
            ...
            {(carA.color || carB.color) && (
              <div className="grid grid-cols-2 divide-x divide-carbon-100 dark:divide-white/5">
                <div className="px-5 py-3.5">
                  <p className="text-xs text-carbon-400 dark:text-carbon-500 mb-0.5 flex items-center gap-1"><Palette size={11} />Couleur</p>
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            {[carA, carB].map(car => (
              <Link
                key={car.id}
                href={`/voiture/${car.id}`}
                className="btn-outline-gold flex items-center justify-center gap-2 text-sm py-3"
              >
                Voir {car.brand} {car.model}
              </Link>
            ))}
          </div>
        </div>
