      ...
      <div className="pt-24 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="mb-10 text-center">
            <p className="text-gold-500 text-sm uppercase tracking-widest font-medium mb-2">Contactez-nous</p>
                ...
                {contactItems.map(({ icon: Icon, label, value, href }) => (
                  <div key={label} className="flex items-start gap-3 bg-white dark:bg-carbon-900/60 border border-carbon-200 dark:border-white/5 rounded-xl p-4">
                    ...
                    <div>
                      ...
                      {href ? (
                        <a href={href} className="text-carbon-950 dark:text-white text-sm font-medium hover:text-gold-500 transition-colors">
                          {value}
                        </a>
                      ) : (
