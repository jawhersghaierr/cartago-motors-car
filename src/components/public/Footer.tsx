            ...
            <div className="flex items-center gap-2.5 shrink-0">
              {settings.facebook_url && (
                <a
                  ...
                  aria-label="Facebook"
                  className="w-9 h-9 rounded-lg bg-carbon-100 dark:bg-white/5 border border-carbon-200 dark:border-white/10 flex items-center justify-center text-carbon-500 hover:text-carbon-950 dark:hover:text-white hover:bg-[#1877F2]/10 hover:border-[#1877F2]/40 hover:text-[#1877F2] transition-all"
                >
              ...
              {settings.instagram_url && (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-carbon-100 dark:bg-white/5 border border-carbon-200 dark:border-white/10 flex items-center justify-center text-carbon-500 hover:text-carbon-950 dark:hover:text-white hover:bg-pink-500/10 hover:border-pink-500/40 hover:text-pink-500 transition-all"
                >
