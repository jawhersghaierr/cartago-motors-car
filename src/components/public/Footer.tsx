        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            {settings.facebook_url ? (
              ...
              <span
                aria-label="Facebook"
                className="w-9 h-9 rounded-lg bg-carbon-100 dark:bg-white/5 border border-carbon-200 dark:border-white/10 flex items-center justify-center text-carbon-300 dark:text-carbon-700 cursor-default"
              >
                <svg
                  width="15"
                  height="15"
