...
export default function FloatingWhatsApp({ number }: Props) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-xl shadow-black/30 transition-transform hover:scale-110 active:scale-95"
